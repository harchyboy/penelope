...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-hartz-gray font-sans">
      ...
      {/* Footer */}
      <footer className="bg-hartz-black text-white py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#how-it-works" className="text-hartz-muted hover:text-white transition-colors text-sm">How it Works</a></li>
                <li><a href="#use-cases" className="text-hartz-muted hover:text-white transition-colors text-sm">Use Cases</a></li>
                <li><a href="#pricing" className="text-hartz-muted hover:text-white transition-colors text-sm">Pricing</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="https://hartzai.com" target="_blank" rel="noopener noreferrer" className="text-hartz-muted hover:text-white transition-colors text-sm">About Hartz AI</a></li>
                <li><a href="#" className="text-hartz-muted hover:text-white transition-colors text-sm">Contact</a></li>
                <li><a href="#" className="text-hartz-muted hover:text-white transition-colors text-sm">Careers</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-hartz-muted hover:text-white transition-colors text-sm">Privacy Policy</a></li>
                <li><a href="#" className="text-hartz-muted hover:text-white transition-colors text-sm">Terms of Service</a></li>
              </ul>
            </div>
          </div>

          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <p className="text-hartz-muted text-sm">&copy; 2025 Hartz AI. All rights reserved.</p>
            <div className="flex gap-6">
              <a href="#" className="text-hartz-muted hover:text-hartz-blue transition-colors">
